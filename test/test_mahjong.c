...
void test_mj_get_score() {
    _test_mj_get_score(m1,m2,m3,p1,p2,p3,s1,s2,s3,s1,s2,s3,s9,s9, p1, 1, wt, wt, MJ_OK, 7, 30, "junchan sanshoku pinfu iipeiko ");
    _test_mj_get_score(m1,m2,m3,p1,p2,p3,wn,wn,wn,s2,s3,s4,s9,s9, p1, 1, wt, wt, MJ_OK, 0, 40, ""); // 役なし
    ...
    _test_mj_get_score(m2,m3,m4,p2,p2,p3,p3,p4,p4,p5,p5,s2,s3,s4, p3, 1, wt, wt, MJ_OK, 4, 40, "sanshoku tanyao iipeiko ");
    // https://mahjongcollege.com/score-calculation/7815/
    _test_mj_get_score(m5,m5,p2,p3,p4,s4,s5,s6,s6,s7,dw,dw,dw,s5, s5, 0, wt, wt, MJ_OK, 2, 40, "haku tsumo ");
