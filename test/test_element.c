...
void test_is_elements_chunchan() {
  ...
  Elements elems2 = {
      {
          {{m2, m3, m4}, 3, false, ELEM_TYPE_SEQUENCE}, {{p1, p2, p3}, 3, false, ELEM_TYPE_SEQUENCE},  // not chunchan
      },
      2};
...
void test_has_elements_routou() {
  ...
  Elements elems2 = {
      {
          {{m1, m2, m3}, 3, false, ELEM_TYPE_SEQUENCE}, {{wt, wt, wt}, 3, false, ELEM_TYPE_TRIPLETS},  // not routou
      },
      2};
